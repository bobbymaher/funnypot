...
final class GrafanaSkin implements Skin
{
    ...
    private function css(): string
    {
        ...
        // every hex is nudged off the product's exact brand tokens — resemblance, not reuse.
        return 'body.gf-body{margin:0;font-family:sans-serif;background:#17181c;color:#d3d5d8}'
            . '.gf-topnav{display:flex;align-items:center;gap:14px;background:#111217;color:#e3d3b8;'
            ...
            . '.gf-rail{width:52px;background:#1c1e24;border-right:1px solid #2a2c33;padding-top:10px;'
            ...
            . '.gf-panel{background:#1c1e24;border:1px solid #2a2c33;border-radius:4px;padding:12px}'
